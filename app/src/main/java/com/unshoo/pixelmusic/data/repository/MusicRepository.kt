...
interface MusicRepository {
    ...
    fun getPaginatedAlbums(
        ...
        storageFilter: com.unshoo.pixelmusic.data.model.StorageFilter = com.unshoo.pixelmusic.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ...
    suspend fun getFavoriteSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.unshoo.pixelmusic.data.model.SortOption = com.unshoo.pixelmusic.data.model.SortOption.LikedSongTitleAZ,
        storageFilter: com.unshoo.pixelmusic.data.model.StorageFilter = com.unshoo.pixelmusic.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.unshoo.pixelmusic.data.model.SortOption = com.unshoo.pixelmusic.data.model.SortOption.SongDefaultOrder,
        storageFilter: com.unshoo.pixelmusic.data.model.StorageFilter = com.unshoo.pixelmusic.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getAlbumsPage(
        limit: Int,
        offset: Int,
        sortOption: com.unshoo.pixelmusic.data.model.SortOption = com.unshoo.pixelmusic.data.model.SortOption.AlbumTitleAZ,
        storageFilter: com.unshoo.pixelmusic.data.model.StorageFilter = com.unshoo.pixelmusic.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ): List<Album>
    ...
    suspend fun getArtistsPage(
        limit: Int,
        offset: Int,
        sortOption: com.unshoo.pixelmusic.data.model.SortOption = com.unshoo.pixelmusic.data.model.SortOption.ArtistNameAZ,
        storageFilter: com.unshoo.pixelmusic.data.model.StorageFilter = com.unshoo.pixelmusic.data.model.StorageFilter.ALL
    ): List<Artist>
     ...
     */
    fun getGenres(): Flow<List<com.unshoo.pixelmusic.data.model.Genre>>
    ...
    fun getMusicFolders(
        storageFilter: com.unshoo.pixelmusic.data.model.StorageFilter = com.unshoo.pixelmusic.data.model.StorageFilter.ALL
    ): Flow<List<com.unshoo.pixelmusic.data.model.MusicFolder>>
    ...
    suspend fun saveTelegramTopics(chatId: Long, topics: List<com.unshoo.pixelmusic.data.database.TelegramTopicEntity>)
    /** Replaces the full topic list for a channel, deleting any topics that no longer exist. */
    suspend fun replaceTopicsForChannel(chatId: Long, freshTopics: List<com.unshoo.pixelmusic.data.database.TelegramTopicEntity>)
    suspend fun getTopicsForChannel(chatId: Long): List<com.unshoo.pixelmusic.data.database.TelegramTopicEntity>
    fun getAllTelegramTopics(): Flow<List<com.unshoo.pixelmusic.data.database.TelegramTopicEntity>>
    suspend fun replaceTelegramSongsForTopic(chatId: Long, threadId: Long, topicName: String, songs: List<Song>)

    val telegramRepository: com.unshoo.pixelmusic.data.telegram.TelegramRepository
